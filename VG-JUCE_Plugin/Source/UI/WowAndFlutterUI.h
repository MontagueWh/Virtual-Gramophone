...
public:
        ...
        : wowAndFlutter(wowAndFlutterData)
    {
        ...
        fFlutterControl.setSliderStyle(juce::Slider::SliderStyle::LinearVertical);
        fFlutterControl.setTextBoxStyle(juce::Slider::TextBoxBelow, true, 75, 25);
        fFlutterControl.setRange(0.0f, 1.0f);
        fFlutterControl.setValue(0.5f);
