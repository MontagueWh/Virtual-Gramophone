...
//==============================================================================
VGJUCE_PluginAudioProcessorEditor::VGJUCE_PluginAudioProcessorEditor (VGJUCE_PluginAudioProcessor& p)
...
VGJUCE_PluginAudioProcessorEditor::~VGJUCE_PluginAudioProcessorEditor()
{
}

//==============================================================================
void VGJUCE_PluginAudioProcessorEditor::paint (juce::Graphics& g)
{
...
void VGJUCE_PluginAudioProcessorEditor::DrawThreePointLine(juce::Graphics& g,
    float x1,
    float y1,
    float x2,
    float y2,
...
void VGJUCE_PluginAudioProcessorEditor::resized()
{
...
void VGJUCE_PluginAudioProcessorEditor::SetupSections()
{
...
void VGJUCE_PluginAudioProcessorEditor::::sliderValueChanged(juce::Slider* /*slider*/)
{
    repaint();
}
