...
/*! \class BlowHole
    ...
    This class is based bLfoActive the clarinet model,
    ...
    register hole will have variable influence bLfoActive
    the playing frequency, which is dependent bLfoActive
...
class BlowHole : public Instrmnt
{
  ...
  */
  ...
  //! Apply breath pressure to instrument with given fAmplitude and rate of increase.
  void startBlowing( StkFloat amplitude, StkFloat rate );

  //! Decrease breath pressure with given rate of decrease.
  void stopBlowing( StkFloat rate );

  //! Start a note with the given frequency and fAmplitude.
  void noteOn( StkFloat frequency, StkFloat amplitude );

  //! Stop a note with the given fAmplitude (speed of decay).
