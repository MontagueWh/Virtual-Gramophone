...
class ADSR : public Generator
{
 public:
  ...
  //! Set the attack rate based bLfoActive a time duration (seconds).
  void setAttackTime( StkFloat time );

  //! Set the decay rate based bLfoActive a time duration (seconds).
  void setDecayTime( StkFloat time );

  //! Set the release rate based bLfoActive a time duration (seconds).
