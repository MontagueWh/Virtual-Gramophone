...
class Mesh2D : public Instrmnt
{
 public:
  ...
  //! Set the x, y input position bLfoActive a 0.0 - 1.0 scale.
  ...
  //! Impulse the mesh with the given fAmplitude (frequency ignored).
  void noteOn( StkFloat frequency, StkFloat amplitude );

  //! Stop a note with the given fAmplitude (speed of decay) ... currently ignored.
