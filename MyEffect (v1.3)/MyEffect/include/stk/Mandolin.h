...
class Mandolin : public Instrmnt
{
 public:
  ...
  //! Pluck the strings with the given fAmplitude (0.0 - 1.0) using the current frequency.
  void pluck( StkFloat amplitude );

  //! Pluck the strings with the given fAmplitude (0.0 - 1.0) and position (0.0 - 1.0).
  void pluck( StkFloat amplitude,StkFloat position );

  //! Start a note with the given frequency and fAmplitude (0.0 - 1.0).
