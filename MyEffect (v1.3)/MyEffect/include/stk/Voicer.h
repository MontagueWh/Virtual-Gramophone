...
class Voicer : public Stk
{
  ...
  */
  ...
  //! Initiate a noteOn event with the given note number and fAmplitude and return a unique note tag.
  /*!
    ...
    -1.  The fAmplitude value should be in the range 0.0 - 128.0.
  */
  ...
  /*!
    The fAmplitude value should be in the range 0.0 - 128.0.
  */
