...
class FileLoop : protected FileWvIn
{
  ...
  */
  ...
  //! Set the data interpolation rate based bLfoActive a looping frequency.
  /*!
    This function determines the interpolation rate based bLfoActive the file
  ...
  */
  ...
  /*!
    This function increments the read pointer based bLfoActive the file
  ...
  */
  ...
  /*!
    This function determines a time offset based bLfoActive the file
