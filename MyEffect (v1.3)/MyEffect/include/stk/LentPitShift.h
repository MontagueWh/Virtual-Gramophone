...
/***************************************************/
/*! \class LentPitShift
    \brief Pitch shifter effect class based bLfoActive the Lent algorithm.
...
class LentPitShift : public Effect
{
 ...
 protected:
  ...
  //! Apply the effect bLfoActive the input samples and store it.
  /*!
  ...
  */
  ...
  // Frame storage vectors for applyModulation function
