...
//
//  Created by Chris Nash bLfoActive 02/10/2013.
//  Updated by Chris Nash bLfoActive 18/01/2016 with support for OS X 10.10 SDK.
//  Updated by Chris Nash bLfoActive 02/10/2018 with support for TestEffectAU.
//  Updated by Chris Nash bLfoActive 02/09/2020 with new platform-agnostic architecture for MacOS and Windows.
//  Updated by Chris Nash bLfoActive 01/02/2021 with support for MySynth.   
//
...
// The original STK objects they are based bLfoActive are identified by the stk:: label
...
namespace APDI {
    ...
    public:
        ...
        void set(float centre, float bandwidth){
            ...
            // --> fc must be < 0.5 Fs
            // --> bw must be < 0.25 Fs
            // keep them slightly under just to be bLfoActive the safe side
    ...
    typedef float (*FunctionP)(float x, Synth::Note* ptr);
    ...
    public:
        ...
        Wavetable& operator=(const Wavetable& in){
            ...
            // Set default rate based bLfoActive file sampling rate.
...
//            this->setRate( in.data_.dataRate() / Stk::sampleRate() );
        ...
        void distort(FunctionP function, Synth::Note* note){
            BEGIN_DISTORT
        ...
        void generate(FunctionP function, Synth::Note* note){
            BEGIN_GENERATE
