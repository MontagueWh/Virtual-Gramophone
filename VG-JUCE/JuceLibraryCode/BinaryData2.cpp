...
"    gramoVoiceEditor.stylusPressureAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.apvts, \"STYLUS_PRESSURE\", gramoVoiceEditor.stylusPressureParam); // Attach the stylus pressure slider to the parameter"
" tree.\n"
"    gramoVoiceEditor.vinylFilterFreqAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.apvts, \"VINYL_FILTER_FREQ\", gramoVoiceEditor.vinylFilterFreqParam); // Attach the vinyl filter frequency slider to th"
"e parameter tree.\n"
...
"    gramoVoiceEditor.soundboxPressureAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.apvts, \"SOUNDBOX_PRESSURE\", gramoVoiceEditor.soundboxPressureParam); // Attach the soundbox pressure slider to the p"
"arameter tree.\n"
...
"    gramoVoiceEditor.hornStiffnessAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.apvts, \"HORN_STIFFNESS\", gramoVoiceEditor.hornStiffnessParam); // Attach the horn stiffness slider to the parameter tre"
"e.\n"
